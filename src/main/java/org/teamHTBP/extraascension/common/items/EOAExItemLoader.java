...
public class EOAExItemLoader {
    ...
    public static final Supplier<Item> BAM_HORN = ITEMS.register("bam_horn",  () -> new Item(new Item.Properties()));
    public static final Supplier<Item> CHARGER_BOXING_GLOVE = ITEMS.register("charger_boxing_glove",  () -> new Item(new Item.Properties()));
    public static final Supplier<Item> NECKLACE_OF_SWAMP = ITEMS.register("necklace_of_swamp",  () -> new Item(new Item.Properties()));
